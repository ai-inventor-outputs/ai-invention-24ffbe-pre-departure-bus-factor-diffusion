...
- **1. create_idea** — `hypo_loop`
  - round_1
    - `chat/prompts/1_create_idea/round_1/1_review_hypo.md` — 6 prompts
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `3_gen_art/` — 3 task(s)
      ...
      - `chat/prompts/2_test_idea/round_1/3_gen_art/gen_art_evaluation_1.md` — 12 prompts
  ...
  - round_2
    ...
    - `3_gen_art/` — 3 task(s)
      ...
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_evaluation_1.md` — 17 prompts
...
- **3. report_results** — `gen_paper_repo`
  ...
  - `2_gen_demo_art/` — 6 task(s)
    ...
    - `chat/prompts/3_report_results/2_gen_demo_art/gen_demo_art_evaluation_2.md` — 14 prompts
